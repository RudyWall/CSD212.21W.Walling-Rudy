...
const game = {
    ...
    reset: function () {
        ...
        document.getElementById("type").innerHTML = document.getElementById("snake-type").options[document.getElementById("snake-type").selectedIndex].text
...
function init() {
    ...
    document.getElementById("snake-color").defaultValue = DEFAULT_SNAKE_COLOR;
    ...
    document.forms[0].addEventListener("input", (e) => {
        ...
        document.getElementById("block-size-preview").style.width = settings.blockSize() + "px";
        document.getElementById("block-size-preview").style.height = settings.blockSize() + "px";
    }
    )
    ...
    document.getElementById("snake-type").addEventListener("change", (e) => {
        let placeholder = settings.snakeType(true).toUpperCase();
        document.getElementById("snake-name").setAttribute("placeholder", placeholder + "ss " + placeholder + "SSsss--<");
    }
    )
    ...
    document.getElementById("snake-name").addEventListener("input", (e) => {
        document.getElementById("snake-name").focus()
        let check = document.getElementById("snake-name").value.charAt(0)
        switch (check) {
            case 'S':
